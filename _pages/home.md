...
I am a computer vision and graphics researcher, pursuing my PhD in [CS@Stanford](https://www.cs.stanford.edu/). I am fortunate to be advised by [Prof. Kayvon Fatahalian](https://graphics.stanford.edu/~kayvonf/). Together, we are currently exploring ideas at the intersection of reinforcement learning and generative models. I am specifically interested in world models, and representation learning for the same. The research question I am pursuing right now is how do we get representations to facilitate fast solutions to 3D games.
